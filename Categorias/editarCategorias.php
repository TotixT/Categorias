<?php
    ...
    $data->setCategoria_ID($Categoria_ID);
    $record = $data->selectOne();
    $val = $record[0];

    if(isset($_POST['editar'])){
        $data->setCategoria_Nombre($_POST['nombresCategoria']);
        $data->setDescripcion($_POST['descripcionesCategoria']);
        $data->setImagen($_POST['imagenesCategoria']);
...
<div class="parte-media">
      ...
      <form class="col d-flex flex-wrap" action=""  method="post">
              <div class="mb-1 col-11">
                <label for="nombresCategoria" class="form-label">Nombre de la Categoria</label>
                <input 
                  type="text"
                  id="nombresCategoria"
              ...
              <div class="mb-1 col-11">
                <label for="descripcionesCategoria" class="form-label">Descripcion</label>
                <input 
                  type="text"
                  id="descripcionesCategoria"
                  name="descripcionesCategoria"
                  class="form-control"
