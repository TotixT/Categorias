<?php
    ...
    if(isset($_POST['editar'])){
        $data->setCelular($_POST['celularCliente']);
        $data->setCompania($_POST['compañiaCliente']);
...
<div class="parte-media">
      ...
      <form class="col d-flex flex-wrap" action=""  method="post">
              ...
              <div class="mb-1 col-11">
                <label for="compañiaCliente" class="form-label">Compañia</label>
                <input 
                  type="text"
                  id="compañiaCliente"
                  name="compañiaCliente"
                  class="form-control"
