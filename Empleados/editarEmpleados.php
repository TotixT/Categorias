<?php
    ...
    $data->setEmpleados_ID($Empleados_ID);
    $record = $data->selectOne();
    $val = $record[0];

    if(isset($_POST['editar'])){
        $data->setNombre($_POST['nombresEmpleado']);
        $data->setCelular($_POST['celularEmpleado']);
        $data->setDireccion($_POST['direccionEmpleado']);
        $data->setImagen($_POST['imagenesEmpleado']);

        $data->update();
        echo "<script> alert('Los Datos fueron Actualizados Exitosamente'); document.location='empleados.php' </script>";
    }
...
<div class="parte-media">
      ...
      <form class="col d-flex flex-wrap" action=""  method="post">
              <div class="mb-1 col-11">
                <label for="nombresEmpleado" class="form-label">Nombre del Empleado</label>
                <input 
                  type="text"
                  id="nombresEmpleado"
              ...
              <div class="mb-1 col-11">
                <label for="imagenesEmpleado" class="form-label">Imagen</label>
                <select id="imagenesEmpleado" name="imagenesEmpleado" class="form-control">
